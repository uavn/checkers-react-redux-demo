...
export const MESSAGE_GO_BLACK = 'Хід чорних'
export const MESSAGE_GO_WHITE = 'Хід білих'
export const MESSAGE_HEY_GO_BEAT_SOMEONE_MORE = 'Можна бити далі'
export const MESSAGE_BLACK_WIN = 'Чорні виграли'
export const MESSAGE_WHITE_WIN = 'Білі виграли'
